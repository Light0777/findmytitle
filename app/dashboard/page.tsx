  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-grid-slate-100 mask-[radial-gradient(ellipse_at_center,white,transparent)]" />
        <div className="relative max-w-6xl mx-auto px-4 py-16">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl md:text-6xl font-bold bg-linear-to-r from-slate-900 via-slate-800 to-slate-900 bg-clip-text text-transparent mb-4">
              FindMyTitle
            </h1>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative group">
              <div className="absolute inset-0 bg-linear-to-r from-blue-500 to-indigo-500 rounded-2xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity" />
              <div className="relative bg-white rounded-2xl shadow-xl border border-slate-200 p-1">
                <div className="flex items-center gap-2">
                  ...
                  <button
                    onClick={getKeywords}
                    disabled={loading}
                    className="bg-linear-to-r from-blue-600 to-indigo-600 text-white px-6 py-3 rounded-xl font-medium hover:shadow-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                  >
                    {loading ? (
                      <>
      ...
      <div className="max-w-6xl mx-auto px-4 pb-16">
        {keywords.length > 0 && (
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-1 h-8 bg-linear-to-b from-blue-600 to-indigo-600 rounded-full" />
                ...
                >
                  <div className="p-5">
                    ...
                    <button
                      ...
                      className="w-full bg-linear-to-r from-slate-100 to-slate-50 hover:from-blue-50 hover:to-indigo-50 text-slate-700 font-medium py-2 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 group/btn"
                    >
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 rounded-lg bg-linear-to-r from-slate-100 to-slate-50 hover:from-blue-50 hover:to-indigo-50 text-slate-600 hover:text-blue-600 transition-all duration-200"
                    >
        ...
        {!keywords.length && !titles.length && (
          <div className="text-center py-20">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-linear-to-br from-blue-50 to-indigo-50 rounded-full mb-6">
